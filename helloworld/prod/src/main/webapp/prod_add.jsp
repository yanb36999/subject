...
<body>
	<h2>添加商品信息</h2>
	<hr/>
	<%-- <form action="${contextPath }/insert.prod" method="POST"> --%>
<!-- 	<form action="insert.prod" method="POST"> -->	
	<form action="<%=request.getContextPath() %>/insert.prod" method="POST">
		<table border="1">
			<tr>
				<td width="30%">商品名称</td>
				<td>
					<input type="text" name="name" placeholder="商品名称不能为空"/>
				</td>
			</tr>
			<tr>
				<td>商品种类</td>
			...
			<tr>
				<td>商品单价</td>
				<td>
					<input type="text" name="price" placeholder="商品单价不能为空"/>
				</td>
			</tr>
			<tr>
				<td>库存数量</td>
				<td>
					<input type="text" name="pnum" placeholder="库存数量不能为空"/>
				</td>
			</tr>
			<tr>
				<td>商品描述</td>
